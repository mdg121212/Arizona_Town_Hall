 ...
 * @param Clicked the link is clicked at least once
 * @param ClicksCount Total number of link clicks (by all recipients).
 */
data class ClickedLink(
    /* Link address. */
    val Url: kotlin.String? = null,
    /* the link is clicked at least once */
    val Clicked: kotlin.Boolean? = null,
    /* Total number of link clicks (by all recipients). */
    val ClicksCount: kotlin.Int? = null
) {
