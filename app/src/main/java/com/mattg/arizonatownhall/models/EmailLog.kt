...
/**
 *
 * @param EmailsIdentifiers A collection of email log record identifiers.
 */
data class EmailLog(
    /* A collection of email log record identifiers. */
    val EmailsIdentifiers: kotlin.Array<kotlin.Int>? = null,
    /* Collection of email log records.  */
    val Emails: kotlin.Array<EmailLogRecord>? = null,
