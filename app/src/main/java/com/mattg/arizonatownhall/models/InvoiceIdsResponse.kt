...
/**
 *
 * @param InvoiceIdentifiers List of invoices identifiers that match request criteria. The field appears if idsOnly parameter was passed in request.
 */
data class InvoiceIdsResponse(
    /* List of invoices identifiers that match request criteria. The field appears if idsOnly parameter was passed in request. */
    val InvoiceIdentifiers: kotlin.Array<kotlin.Int>? = null
) {
