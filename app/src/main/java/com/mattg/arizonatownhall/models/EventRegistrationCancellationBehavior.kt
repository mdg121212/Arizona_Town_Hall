 ...
 * Values: doNotAllow,allowUpToPeriodBeforeEvent,allow
 */
enum class EventRegistrationCancellationBehavior(val value: kotlin.String) {

    @Json(name = "DoNotAllow")
    doNotAllow("DoNotAllow"),

    @Json(name = "AllowUpToPeriodBeforeEvent")
    allowUpToPeriodBeforeEvent("AllowUpToPeriodBeforeEvent"),
