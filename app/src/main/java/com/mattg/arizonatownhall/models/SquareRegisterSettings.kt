 ...
 * @param IntegrationEnabled Is integration enabled in admin UI.
 * @param ClientId (optional) Square client Id
 */
data class SquareRegisterSettings(
    /* Is integration enabled in admin UI. */
    val IntegrationEnabled: kotlin.Boolean,
