...
/**
 *
 * @param Events List of events that match request criteria.
 * @param Count Number of events that match request criteria. This field appears only if $count parameter was passed in request.
 */
data class EventsResponse(
    ...
    val EventsIdentifiers: kotlin.Array<kotlin.Int>? = null,
