 ...
 * Values: undefined,onlineAndOffline,offlineOnly,onlineOnly
 */
enum class EventPaymentMethodType(val value: kotlin.String) {

    @Json(name = "Undefined")
    undefined("Undefined"),

    @Json(name = "OnlineAndOffline")
    onlineAndOffline("OnlineAndOffline"),

    @Json(name = "OfflineOnly")
