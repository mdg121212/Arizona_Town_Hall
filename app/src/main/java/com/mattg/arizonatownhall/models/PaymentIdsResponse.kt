...
/**
 *
 * @param PaymentIdentifiers List of payment identifiers that match request criteria. The field appears if idsOnly parameter was passed in request.
 */
data class PaymentIdsResponse(
    /* List of payment identifiers that match request criteria. The field appears if idsOnly parameter was passed in request. */
    val PaymentIdentifiers: kotlin.Array<kotlin.Int>? = null
) {
