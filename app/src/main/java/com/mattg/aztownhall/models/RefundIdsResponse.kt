...
/**
 *
 * @param RefundIdentifiers List of refund identifiers that match request criteria. The field appears if idsOnly parameter was passed in request.
 */
data class RefundIdsResponse(
    /* List of refund identifiers that match request criteria. The field appears if idsOnly parameter was passed in request. */
    val RefundIdentifiers: kotlin.Array<kotlin.Int>? = null
) {
