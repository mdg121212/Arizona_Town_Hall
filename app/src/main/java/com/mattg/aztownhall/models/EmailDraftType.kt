...
/**
 *
 * Values: unknown,contactBlast,eventAttendees,eventWaitlistPersons
 */
enum class EmailDraftType(val value: kotlin.String) {

    @Json(name = "Unknown")
    unknown("Unknown"),

    @Json(name = "ContactBlast")
    contactBlast("ContactBlast"),

    @Json(name = "EventAttendees")
    eventAttendees("EventAttendees"),

    @Json(name = "EventWaitlistPersons")
    eventWaitlistPersons("EventWaitlistPersons");
