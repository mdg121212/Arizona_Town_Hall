 ...
 */
data class ContactExtendedMembershipInfo(
    ...
    val status: ContactExtendedMembershipInfo.Status? = null,
    val ExtendedMembershipInfo: ExtendedMembershipInfo? = null,
