...
/**
 *
 * @param FieldName Field name title, could be displayed in user interface. Field name could be changed by account administrator.
 * @param SystemCode System-defined code associated with field. It does not change even if FieldName is edited in admin backend.
 * @param DisplayType Optional hint, which tells how to display and edit field. It appears for String and Choice fields.
 * @param IsSystem Field is system-defined and could not be deleted. However, field name could be changed by account administrator.
 * @param Description System-defined description of the field. Empty for custom fields.
 * @param FieldInstructions Admin-defined comment for the field. Shown as a tip when members or visitors fill in forms.
 * @param AllowedValues If field value is limited to set of predefined values, this contains list of allowed values. Normally, AllowedValues appear for MultipleChoice and Choice fields.
 * @param Order Sorting order to display the field in UI
 * @param RulesAndTermsInfo
 */
data class EntityFieldDescription(
