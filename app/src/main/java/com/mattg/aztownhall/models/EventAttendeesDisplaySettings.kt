 ...
 * @param VisibleTo
 * @param ShowPendingAttendees Indicates if pending registrants should be included in the list of registrants.
 */
data class EventAttendeesDisplaySettings(
    val VisibleTo: String? = null,
    /* Indicates if pending registrants should be included in the list of registrants. */
    val ShowPendingAttendees: kotlin.Boolean? = null
) {
