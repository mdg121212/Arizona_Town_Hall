...
/**
 *
 * @param EventsIdentifiers List of event identifiers that match request criteria. The field appears only if idsOnly parameter was passed in request.
 */
data class EventIdsResponse(
