 ...
 * @param Recipients
 * @param ContextEventId context event identifier. not required. for Event related recipient types only
 */
data class EmailRecipientsParams(
    val Recipients: kotlin.Array<EmailRecipient>? = null,
    /* context event identifier. not required. for Event related recipient types only */
    val ContextEventId: kotlin.Int? = null
) {
